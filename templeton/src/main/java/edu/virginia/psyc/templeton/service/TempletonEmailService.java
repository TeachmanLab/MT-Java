...
public class TempletonEmailService extends EmailServiceImpl implements EmailService{
    private String PRE_TEST = "preTest";
    private String FIRST_SESSION = "firstSession";
    private String SECOND_SESSION = "secondSession";
    private String THIRD_SESSION = "thirdSession";
    private String FOURTH_SESSION = "fourthSession";
    private String POST_FOLLOWUP = "postFollowUp";

    @Override
    public List<Email> emailTypes() {
        List<Email> emails = super.emailTypes();
        emails.add(new Email(PRE_TEST, "Bonus feature from the MindTrails team"));
        ...
        emails.add(new Email(POST_FOLLOWUP, "Bonus feature from the MindTrails team"));
        return emails;
    }
