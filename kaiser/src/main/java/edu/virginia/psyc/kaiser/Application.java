package edu.virginia.psyc.kaiser;
 ...
 */
@ComponentScan ({"edu.virginia.psyc.kaiser", "org.mindtrails"})
@Configuration
@EnableJpaRepositories(basePackages = {"edu.virginia.psyc.kaiser", "org.mindtrails"})
@EnableAutoConfiguration
@EnableAspectJAutoProxy
@EntityScan(basePackages = {"edu.virginia.psyc.kaiser", "org.mindtrails"})
@EnableScheduling
