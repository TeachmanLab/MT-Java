...
import edu.virginia.psyc.kaiser.persistence.OARepository;
import edu.virginia.psyc.kaiser.service.KaiserEmailService;
...
public class OAController extends QuestionController {
    ...
    @Autowired
    private KaiserEmailService emailService;
