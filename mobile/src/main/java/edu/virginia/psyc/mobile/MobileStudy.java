...
//        sessions.add(pretest);
        ...
        session1.addTask(new Task("OA","Mood Assessment", Task.TYPE.questions,2));
        ...
        session2.addTask(new Task("OA","Mood Assessment", Task.TYPE.questions,2));
        ...
        session3.addTask(new Task("OA","Mood Assessment", Task.TYPE.questions,2));
        ...
        session4.addTask(new Task("OA","Mood Assessment", Task.TYPE.questions,2));
        ...
        session5.addTask(new Task("OA","Mood Assessment", Task.TYPE.questions,2));
        ...
        session6.addTask(new Task("OA","Mood Assessment", Task.TYPE.questions,2));
