package edu.virginia.psyc.mobile.controller;


import edu.virginia.psyc.mobile.MobileStudy;
import edu.virginia.psyc.mobile.persistence.OA;
import edu.virginia.psyc.mobile.persistence.OARepository;
...
public class GraphController extends BaseController {
    ...
    public String graph(ModelMap model, Principal principal) {
        ...
        MobileStudy study = (MobileStudy)p.getStudy();
