 ...
 */
@ComponentScan ({"edu.virginia.psyc", "org.mindtrails.basic"})
@Configuration
@EnableJpaRepositories(basePackages = {"edu.virginia.psyc", "org.mindtrails.basic"})
@EnableAutoConfiguration
@EntityScan(basePackages = {"edu.virginia.psyc", "org.mindtrails.basic"})
@EnableScheduling
