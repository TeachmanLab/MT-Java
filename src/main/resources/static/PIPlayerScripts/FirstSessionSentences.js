            ...
            data:[
                    ...
                    "stimuli": [
                        {"inherit": {"set": "error"}},
                        {
                            ...
                            "media":
                            {
                                "inlineTemplate": "<div>You are out to dinner on a date. </div>"
                            }
                        },
                        {
                            "handle":"space",
                            "media":
                            {
                                "inlineTemplate": "<div>As you look into your date\u2019s eyes, you are unsure whether he/she will ask you out for another date.</div>"
                            }
                        },
                        {
                            "handle": "space",
                            "media":
                            {
                                "inlineTemplate": "<div> The feeling of uncertainty is </div>"
                            }
                        }
                        {
                            "data": {
