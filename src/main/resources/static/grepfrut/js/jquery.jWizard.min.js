! function($, undefined) {
    $.widget("db.jWizard", {
        ...
        _buildTitle: function() {
            ...
            this.$header = $('<div class="jw-header ui-widget-header ui-corner-top ui-helper-clearfix">').append(this.$title).prependTo(this.element);
            this._updateTitle()
        },
        ...
        _destroySteps: function() {
            this.$steps.show().unwrap().unwrap().removeData("jwizard-title").removeClass("jw-step");
            this.$steps = null
        },
        _buildMenu: function() {
            var wizard = this;
            ...
            this.$menuWrap = $('<div class="jw-menu-wrap">').append(this.$menu).prependTo(this.element.children(".jw-content"));
            this._updateMenu()
        },
        _updateMenu: function() {
            if (!this.$menu) return;
            var index = this.$current.index();
            this.$menu.children("li").removeClass("ui-state-highlight ui-state-disabled").eq(index).addClass("ui-state-highlight").end().slice(index).addClass("ui-state-disabled")
        },
        ...
        _buildButtons: function() {
            ...
            $.each(this.options.buttons, function(type, data) {
                ...
                if (data) {
                    wizard["$" + type] = $("<button>", options).button({
                        icons: icons
            ...
            if (this._on) {
                ...
                this.element.on("click", ".jw-button-cancel", function() {
                    wizard.cancel()
