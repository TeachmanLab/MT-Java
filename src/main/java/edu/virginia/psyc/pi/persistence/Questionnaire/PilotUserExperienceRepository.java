 ...
 */
public interface PilotUserExperienceRepository extends JpaRepository<PilotUserExperience, Long> {

    List<PilotUserExperience> findByParticipantDAO(ParticipantDAO p);
