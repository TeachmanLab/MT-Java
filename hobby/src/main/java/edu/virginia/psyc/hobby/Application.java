package edu.virginia.psyc.hobby;
 ...
 */
@ComponentScan ({"edu.virginia.psyc.hobby", "org.mindtrails"})
@Configuration
@EnableJpaRepositories(basePackages = {"edu.virginia.psyc.hobby", "org.mindtrails"})
@EnableAutoConfiguration
@EntityScan(basePackages = {"edu.virginia.psyc.hobby", "org.mindtrails"})
@EnableScheduling
